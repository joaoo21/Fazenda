 ...
 * @author Avell
 */
public class ListagemManejo extends javax.swing.JDialog {
...
if (evt.getClickCount() == 2) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListagemManejo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ListagemManejo dialog = new ListagemManejo(new javax.swing.JFrame(), true);
