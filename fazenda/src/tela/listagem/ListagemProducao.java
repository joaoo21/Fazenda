...
import controlador.ControladorProducao;
...
public class ListagemProducao extends javax.swing.JDialog {
    ...
    public ListagemProducao(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ControladorProducao.atualizarTabela(tabela);
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Produção de leite");
...
if (evt.getClickCount() == 2) {
            ...
            //abre a manutenção
            ManutencaoProducao manutencao = new ManutencaoProducao(null, true, this, pk);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ListagemProducao dialog = new ListagemProducao(new javax.swing.JFrame(), true);
