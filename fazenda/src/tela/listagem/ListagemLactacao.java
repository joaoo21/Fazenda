...
import controlador.ControladorLactacao;
...
public class ListagemLactacao extends javax.swing.JDialog {
     ...
     */
    public ListagemLactacao(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ControladorLactacao.atualizarTabela(tabela);
    }
...
ManutencaoLactacao manutencao = new ManutencaoLactacao(null, true, this);
...
if (evt.getClickCount() == 2) {
            ...
            //abre a manutenção
            ManutencaoLactacao manutencao = new ManutencaoLactacao(null, true, this, pk);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListagemLactacao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ListagemLactacao dialog = new ListagemLactacao(new javax.swing.JFrame(), true);
