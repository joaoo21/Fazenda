...
import controlador.ControladorVaca;
...
public class ListagemVaca extends javax.swing.JDialog {
    ...
    /**
     * Creates new form ListagemVaca
     */
    public ListagemVaca(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ControladorVaca.atualizarTabela(tabela);
    }
...
if (evt.getClickCount() == 2) {
            ...
            //abre a manutenção
            ManutencaoVaca manutencao = new ManutencaoVaca(null, true, this, pk);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ListagemVaca dialog = new ListagemVaca(new javax.swing.JFrame(), true);
